            ...
            <div className='w-full flex justify-between mt-9'>
                <div className='w-6/12'>
                    ...
                    <div className='md:flex items-center'>
                        <FaCircle className=' mt-2 mr-2 text-[#00BCE3]'></FaCircle> <Text> <Bold>Si</Bold> contaba con Licencia <span className="text-xs text-red-300">({RSi.length})</span></Text>
                    </div>
                ...
                <div className='w-6/12 py-0'>
                    <div className='md:flex items-center'>
                        <FaCircle className=' mt-2 mr-2 text-[#8b5cf6]'></FaCircle> <Text> <Bold>NO</Bold> contaba con Licencia <span className="text-xs text-red-300">({RNo.length})</span></Text>
                    </div>
...
export default GrafDonutChartIV3;
