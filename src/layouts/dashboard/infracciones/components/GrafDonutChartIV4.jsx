...
const GrafDonutChartIV4 = () => {
    ...
    const infraccionConductorPresente = [
        {
            name: "Publico",
            sales: parseInt(publico.length),
        },
        {
            name: "Privado",
            sales: parseInt(privado.length),
        },
            ...
            <div className='w-full flex justify-between mt-9'>
                <div className='w-6/12'>
                    ...
                    <div className='md:flex items-center'>
                        <FaCircle className=' mt-2 mr-2 text-[#00BCE3]'></FaCircle><Text>Transporte <Bold>PUBLICO</Bold> <span className="text-xs text-red-300">({publico.length})</span></Text>
                    </div>
                ...
                <div className='w-6/12 py-0'>
                    <div className='md:flex items-center'>
                        <FaCircle className=' mt-2 mr-2 text-[#8b5cf6]'></FaCircle><Text>Transporte <Bold>PRIVADO</Bold> <span className="text-xs text-red-300">({privado.length})</span></Text>
                    </div>
...
export default GrafDonutChartIV4;
